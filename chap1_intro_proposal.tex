...
%
Floating-point reduction, low-buffering message passing, nondeterminism of application, and collective operations are just some examples of uncertain behavior of HPC applications.
%
